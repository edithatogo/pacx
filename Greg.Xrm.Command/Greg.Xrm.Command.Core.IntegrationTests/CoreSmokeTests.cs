...
namespace Greg.Xrm.Command.IntegrationTests
{
    ...
    public class CoreSmokeTests : IntegrationTestBase
    {
        ...
        public void SmokeTestAuthConnectionShouldConnect()
        {
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void SmokeTestOrganizationListShouldRetrieve()
        {
            if (!IsConnected) return;
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void SmokeTestSolutionListShouldRetrieve()
        {
            if (!IsConnected) return;
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void SmokeTestTableCreateDeleteShouldRoundTrip()
        {
            if (!IsConnected) return;
            ...
            try
            {
                ...
                table["displayname"] = new Microsoft.Xrm.Sdk.Label("Smoke Test Table", 1033);
        ...
        [TestMethod]
        [TestCategory("Integration")]
        public void SmokeTestPublisherCreateDeleteShouldRoundTrip()
        {
            if (!IsConnected) return;
