...
namespace Greg.Xrm.Command.IntegrationTests
{
	...
	public abstract class IntegrationTestBase
	{
		...
		public void TestInitialize()
		{
			...
			try
			{
				var connectionOptions = new Microsoft.PowerPlatform.Dataverse.Client.Model.ConnectionOptions
				{
				...
				CrmService = new ServiceClient(
					connectionOptions,
					true,
					new Microsoft.PowerPlatform.Dataverse.Client.Model.ConfigurationOptions());
