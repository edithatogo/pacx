...
namespace Greg.Xrm.Command.Commands.UserSettings
{
	...
	public class SetCommandExecutorTest
	{
		...
		public async Task ExecuteAsync_ShouldSucceed_IntegerField_CurrentUser()
		{
			...
			crmMock.Verify(c => c.UpdateAsync(It.IsAny<Entity>(), It.IsAny<CancellationToken>()), Times.Once);
		}
		...
		public async Task ExecuteAsync_ShouldSucceed_BooleanField(string rawValue, bool expected)
		{
			...
			crmMock.Setup(c => c.ExecuteAsync(It.IsAny<WhoAmIRequest>(), It.IsAny<CancellationToken>())).ReturnsAsync(whoAmI);
			crmMock.Setup(c => c.ExecuteAsync(It.IsAny<WhoAmIRequest>(), It.IsAny<CancellationToken>())).ReturnsAsync(whoAmI);
			crmMock
				.Setup(c => c.UpdateAsync(It.IsAny<Entity>(), It.IsAny<CancellationToken>()))
				.Callback<Entity, CancellationToken>((e, _) => capturedUpdate = e)
		...
		public async Task ExecuteAsync_ShouldSucceed_LanguageField_ValidatesDataverse()
		{
			...
			crmMock.Verify(c => c.ExecuteAsync(It.IsAny<RetrieveAvailableLanguagesRequest>(), It.IsAny<CancellationToken>()), Times.Once);
		}
		...
		public async Task ExecuteAsync_ShouldSucceed_WithExplicitUser()
		{
			...
			crmMock.Verify(c => c.ExecuteAsync(It.IsAny<WhoAmIRequest>(), It.IsAny<CancellationToken>()), Times.Never);
		}
		...
		public async Task ExecuteAsync_ShouldFail_WhenKeyIsUnknown()
		{
			...
			repoMock.Verify(r => r.GetCurrentConnectionAsync(It.IsAny<CancellationToken>()), Times.Never);
			crmMock.Verify(c => c.UpdateAsync(It.IsAny<Entity>(), It.IsAny<CancellationToken>()), Times.Never);
		}
