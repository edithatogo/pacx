...
namespace Greg.Xrm.Command.Commands.Settings.Model
{
	public class AppSetting : EntityWrapper
	{
		...
		public class Repository : IAppSettingRepository
		{
			...
			public async Task<IReadOnlyList<AppSetting>> GetByDefinitionsAsync(IOrganizationServiceAsync2 crm, IReadOnlyList<SettingDefinition> settingDefinitionList, CancellationToken cancellationToken = default)
			{
