...
namespace Greg.Xrm.Command.Commands.Settings.Model
{
	public class OrganizationSetting : EntityWrapper
	{
		...
		public class Repository : IOrganizationSettingRepository
		{
			...
			public async Task<IReadOnlyList<OrganizationSetting>> GetByDefinitionsAsync(IOrganizationServiceAsync2 crm, IReadOnlyList<SettingDefinition> settingDefinitionList, CancellationToken cancellationToken = default)
			{
