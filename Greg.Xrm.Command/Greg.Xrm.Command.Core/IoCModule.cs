...
namespace Greg.Xrm.Command
{
	public class IoCModule : Module
	{
		protected override void Load(ContainerBuilder builder)
		{
			...
			builder.RegisterType<Services.Fabric.FabricClient>().As<Services.Fabric.IFabricClient>();
			builder.RegisterType<Services.PowerBi.PowerBiClient>().As<Services.PowerBi.IPowerBiClient>();
			builder.RegisterType<Services.DesktopFlows.DesktopFlowClient>().As<Services.DesktopFlows.IDesktopFlowClient>();
			builder.RegisterType<Services.PowerFx.PowerFxValidationService>().As<Services.PowerFx.IPowerFxValidationService>();
			builder.RegisterType<Services.CopilotStudio.CopilotStudioClient>().As<Services.CopilotStudio.ICopilotStudioClient>();
			builder.RegisterType<Services.DataverseGaps.DataverseGapClient>().As<Services.DataverseGaps.IDataverseGapClient>();
			builder.RegisterType<ConstantsGeneratorService>().As<IConstantsGeneratorService>();
			builder.RegisterType<Commands.Connector.ConnectorSchemaValidator>().As<Commands.Connector.IConnectorSchemaValidator>();
			builder.RegisterType<Commands.Validate.CatalogContractValidator>().As<Commands.Validate.ICatalogContractValidator>();
			...
			builder.RegisterType<PacxPackageReleaseVerifier>().As<IPacxPackageReleaseVerifier>();
			builder.RegisterType<PacxPackageDeployer>().As<IPacxPackageDeployer>();
			builder.RegisterType<Services.Tooling.ToolCatalog>().AsSelf();
			...
			builder.RegisterType<Services.AsyncJobPoller.AsyncJobPoller>().As<Services.AsyncJobPoller.IAsyncJobPoller>();
			...
			builder.RegisterType<Services.Forms.FormsTokenProvider>().As<Services.Forms.IFormsTokenProvider>();
			builder.RegisterType<Services.Forms.FormsApiClient>().As<Services.Forms.IFormsApiClient>();
			builder.RegisterType<Services.Tabular.TabularClient>().As<Services.Tabular.ITabularClient>();
		}
	}
}
