...
namespace Greg.Xrm.Command.Model
{
	public class ProcessTrigger : EntityWrapper
	{
		...
		{
			public async Task<IReadOnlyList<ProcessTrigger>> GetByWorkflowIdAsync(IOrganizationServiceAsync2 crm, Guid workflowId, CancellationToken cancellationToken = default)
			{
