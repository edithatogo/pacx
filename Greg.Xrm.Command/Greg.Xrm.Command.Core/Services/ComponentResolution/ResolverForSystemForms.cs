...
namespace Greg.Xrm.Command.Services.ComponentResolution
{
	public class ResolverForSystemForms(ILogger log) : IComponentResolver
	{
		...
		public async Task<Dictionary<Guid, string>> GetNamesAsync(IOrganizationServiceAsync2 crm, IReadOnlyList<Guid> componentIdSet, CancellationToken cancellationToken)
		{
