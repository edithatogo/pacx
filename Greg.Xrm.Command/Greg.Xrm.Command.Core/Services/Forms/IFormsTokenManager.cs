...
namespace Greg.Xrm.Command.Services.Forms
{
	...
	public class FormsTokenManager : IFormsTokenManager
	{
		...
		public async Task<string> GetAccessTokenAsync(CancellationToken cancellationToken = default)
		{
			...
			{
				if (_publicClientApp is null)
				{
					throw new InvalidOperationException("ROPC token acquisition was requested but no public client application was configured.");
				}
			...
			{
				if (_confidentialClientApp is null)
				{
					throw new InvalidOperationException("Client credential token acquisition was requested but no confidential client application was configured.");
				}
