...
namespace Greg.Xrm.Command
{
	public static class Extensions
	{
		...
		/// <returns></returns>
		public static async Task CheckManyToManyEligibilityAsync(this IOrganizationServiceAsync2 crm, string entity, CancellationToken cancellationToken = default)
		{
			...
			var canManyToManyResponse = (CanManyToManyResponse)await crm.ExecuteAsync(canManyToManyRequest, cancellationToken);
		...
		public static async Task CheckManyToManyExplicitEligibilityAsync(this IOrganizationServiceAsync2 crm, string table1, string table2, CancellationToken cancellationToken = default)
		{
			var request1 = new CanBeReferencedRequest
			{
				EntityName = table1
			};
			var response1 = (CanBeReferencedResponse)await crm.ExecuteAsync(request1, cancellationToken);
			...
			var response2 = (CanBeReferencedResponse)await crm.ExecuteAsync(request2, cancellationToken);
		...
		public static async Task CheckManyToOneEligibilityAsync(this IOrganizationServiceAsync2 crm, string parentTable, string childTable, CancellationToken cancellationToken = default)
		{
			await crm.CheckManyToOneEligibilityAsync(new[] { parentTable }, childTable, cancellationToken);
		}
		...
		/// <returns></returns>
		public static async Task CheckManyToOneEligibilityAsync(this IOrganizationServiceAsync2 crm, string[] parentTables, string childTable, CancellationToken cancellationToken = default)
		{
			...
			var response2 = (CanBeReferencingResponse)await crm.ExecuteAsync(request2, cancellationToken);
		...
		public static async Task<EntityMetadata> GetEntityMetadataAsync(this IOrganizationServiceAsync2 crm, string entityName, CancellationToken cancellationToken = default)
		{
		...
		{
			return GetAliasedValue<T>(entity, string.Format(CultureInfo.InvariantCulture, "{0}.{1}", alias, attributeLogicalName));
		}
