...
### Priority 7: Repo Hardening & Capability Expansion (Planning)
- [ ] **Track: Repo Hardening & Capability Expansion**
  *Link: [./tracks/repo_hardening_capability_expansion_20260428/](./tracks/repo_hardening_capability_expansion_20260428/)*
  *Status: PLANNED — umbrella backlog for release/provenance hardening, integration and parity validation, contract/schema expansion, repo hygiene, observability, and next capability slices.*

- [ ] **Track: Release & Supply Chain Hardening**
  *Link: [./tracks/release_supply_chain_hardening_20260428/](./tracks/release_supply_chain_hardening_20260428/)*
  *Status: IN PROGRESS — signed releases, provenance, SBOMs, and promotion workflow hardening.*

- [ ] **Track: Validation, Parity & Coverage**
  *Link: [./tracks/validation_parity_coverage_20260428/](./tracks/validation_parity_coverage_20260428/)*
  *Status: IN PROGRESS — live integration coverage, command/doc parity checks, catalog contract validation, schema expansion, and validate-all orchestration.*

- [x] **Track: Adjacent Ecosystem Intake**
  *Link: [./tracks/adjacent_ecosystem_intake_20260428/](./tracks/adjacent_ecosystem_intake_20260428/)*
  *Status: COMPLETED — XrmToolBox-style tool library, Flow Studio capability surfaces, Dataverse skills, PAC CLI discovery parity, and package/source browsing.*

- [x] **Track: Flow Studio Capability Surfaces**
  *Link: [./tracks/flow_studio_mcp_surfaces_20260428/](./tracks/flow_studio_mcp_surfaces_20260428/)*
  *Status: COMPLETED — packaged Flow Studio-style capability parity for authoring, debugging, monitoring, and governance workflows.*

- [x] **Track: Dataverse Skill-Pack Guidance**
  *Link: [./tracks/dataverse_skill_pack_guidance_20260428/](./tracks/dataverse_skill_pack_guidance_20260428/)*
  *Status: COMPLETED — reusable Dataverse operational guidance and skill-pack style recipes for docs and automation.*

- [ ] **Track: Microsoft Release Plan Intelligence**
  *Link: [./tracks/release_plan_intelligence_20260428/](./tracks/release_plan_intelligence_20260428/)*
  *Status: PLANNED — PACX-native browsing, snapshotting, diffing, and export for Microsoft Power Platform release-plan families.*

- [ ] **Track: Microsoft Forms Authoring**
  *Link: [./tracks/forms_authoring_20260428/](./tracks/forms_authoring_20260428/)*
  *Status: IN PROGRESS — phase 1-5 complete; PACX-native source-controlled create, inspect, update, delete, publish, and question/section manipulation for Microsoft Forms.*
...
repo_hardening_capability_expansion_20260428 ─────→ security_supply_chain, ci_cd_hardening, cli_ux, testing_maturity, documentation_site, correlation_id_telemetry, connector_schema_validation
release_supply_chain_hardening_20260428 ───────────→ ci_cd_hardening, security_supply_chain, documentation_site
validation_parity_coverage_20260428 ─────────────→ testing_maturity, connector_schema_validation, correlation_id_telemetry, documentation_site, cli_ux
adjacent_ecosystem_intake_20260428 ───────────────→ documentation_site, cli_ux, fabric_onelake, powerbi_workspace_mgmt, correlation_id_telemetry, repo_hardening_capability_expansion_20260428
flow_studio_mcp_surfaces_20260428 ───────────────→ adjacent_ecosystem_intake_20260428, documentation_site, cli_ux, correlation_id_telemetry, mcp_server
dataverse_skill_pack_guidance_20260428 ──────────→ adjacent_ecosystem_intake_20260428, documentation_site, cli_ux, correlation_id_telemetry
release_plan_intelligence_20260428 ──────────────→ documentation_site, cli_ux, validation_parity_coverage_20260428
forms_authoring_20260428 ────────────────────────→ ms_forms_20260409, forms_advanced_20260421, documentation_site, cli_ux
...
9. **Umbrella backlog** — `repo_hardening_capability_expansion_20260428` for release hardening, validation expansion, repo hygiene, diagnostics, and next capability slices; split into child tracks when the phases are sharpened.
10. **Child tracks ready** — `release_supply_chain_hardening_20260428` and `validation_parity_coverage_20260428` are the first concrete descendants.
11. **Ecosystem intake** — `adjacent_ecosystem_intake_20260428` covers XrmToolBox/Flow Studio/Dataverse skills/PAC CLI/package-source discovery ideas.
12. **Ecosystem child tracks** — `flow_studio_mcp_surfaces_20260428` and `dataverse_skill_pack_guidance_20260428` split the remaining flow/MCP and Dataverse guidance work.
13. **Release-plan intelligence** — `release_plan_intelligence_20260428` captures Microsoft release-plan browsing, snapshotting, diffing, and export for roadmap planning.
14. **Forms authoring** — `forms_authoring_20260428` extends Microsoft Forms from read/export workflows into create/update/delete/publish and question/section manipulation.
