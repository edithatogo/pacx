...
public class StartupBenchmarks
{
    ...
    public static object FullStartupHelpCommand()
    {
    ...
    public static object FullStartupTableCreateCommand()
    {
        var serviceCollection = new ServiceCollection();
    ...
    public static ICommandRegistry CommandRegistryInitialization()
    {
