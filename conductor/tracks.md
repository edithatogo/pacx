...
- [ ] **Track: PR Lifecycle & CI/CD Improvements**
  ...
  *Description: Automated PR open/track/merge, conductor:review integration, CI test execution, coverage enforcement, CodeQL, mutation testing. ALL tracks depend on this.**
...
0. `pr_lifecycle` — **MUST come first** — sets up CI test execution, coverage, review automation
