...
### Tier 5: Infrastructure & Cross-Cutting
- [ ] **Track: PR Lifecycle & CI/CD Improvements**
  *Link: [./tracks/pr_lifecycle_20260409/](./tracks/pr_lifecycle_20260409/)*
  *Description: Automated PR open/track/merge via Ralph loop, CI test execution, coverage enforcement, CodeQL, mutation testing. ALL tracks depend on this.*

- [ ] **Track: E2E Smoke Tests & Integration Tests**
  *Link: [./tracks/e2e_smoke_tests_20260409/](./tracks/e2e_smoke_tests_20260409/)*
  *Description: Real Dataverse environment tests, CI workflow with GitHub Secrets, secure credentials, automatic cleanup. Depends on: pr_lifecycle.*

- [ ] **Track: Plugin Loading Test Coverage**
  *Link: [./tracks/plugin_test_coverage_20260409/](./tracks/plugin_test_coverage_20260409/)*
  *Description: CommandRegistry, PluginLoader, Bootstrapper tests — currently 0% coverage. Mock plugin DLLs, edge case testing, >90% coverage target.*

- [ ] **Track: Microsoft Forms CLI**
  *Link: [./tracks/ms_forms_20260409/](./tracks/ms_forms_20260409/)*
  *Description: List forms, export responses, response count. Undocumented Forms API via OAuth2. Phase 13 of roadmap.*
...
```
pr_lifecycle ───────────────────────────────────────────────────→ (no deps) [CRITICAL — all tracks depend on this]
...
plugin_test_coverage ───────────────────────────────────────────→ (no deps)
ai_builder_connectors ──────────────────────────────────────────→ (no deps)
ms_forms ───────────────────────────────────────────────────────→ (no deps)
```

## Execution Order (Recommended)
0a. `pr_lifecycle` — **MUST come first** — sets up CI test execution, coverage, review automation
0b. `e2e_smoke_tests` — real environment tests, depends on CI infrastructure from #0a
0c. `plugin_test_coverage` — 0% coverage risk area, should be done before any feature adds plugins
...
13. `ms_forms` — Forms CLI capability
